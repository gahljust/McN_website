...
Now you have edited the file and saved your changes. There are many editors inside and outside the terminal, and over time you will likely use many of them. But this is a simple way to start.
...
### 10. Edit the permissions of a file
...
You will now be prompted to enter your password. Enter your password and press enter. Get your password from Dr. McNulty.
Thats it! You are now connected to the daq3 server. You can use 'ls' and have a look at the file structure. Then go ahead and disconnect from the server by typing `exit` and pressing enter.
...
If havve trouble doing this, go back to part 1 of this tutorial.
...
<Tabs items={['macOS/Linux', 'Windows PowerShell', 'Windows Command Prompt']}>
  <Tab>
```    sh {3} copy
    scp daq@daq3.physics.isu.edu:/home/daq [local_file_path]/terminal-tutorial
    ```
</Tab>
<Tab>
```sh {3} copy
