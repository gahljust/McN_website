...
This essentially completes the analysis. But, this isn't very presentable. So, wee will make a few cahnges to the way or results are displayed.

#### Setting Presentation settings

We will start by changing the title of the histogram. We will also change the axis labels. We will also change the color of the histogram. Let's add this to our macro:
...
Great! Now we have a nice looking plot. But we don't need the stats from the histogram in the stat we actually want our fit results. So, we will remove the histogram stats. We will do this by adding this line to the top of the macro.
