...
- Ultimaker S5 User Manual: [Manual](https://support.makerbot.com/s/article/1667410778241)
- Fusion 360 Tutorials: [Fusion Tutorials](https://help.autodesk.com/view/fusion360/ENU/courses/)
- Using Cura: [Getting Started](https://support.makerbot.com/s/article/1667410778218)

## Prerequisites

- A computer with Fusion 360 [installed](/Tutorials/CAD/Basics). You can use any CAD software you like, but this tutorial will use Fusion 360.
- A USB drive to transfer files between the computers.


## Cura Download and Installation
Download the latest version of Ultimaker Cura from the official website: [Download](https://ultimaker.com/software/ultimaker-cura).
...
<div align = "center">
<Image src="/images/3dprint/3dpr_001.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_002.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_003.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_004.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_005.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_006.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_007.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_008.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_009.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_010.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_011.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_012.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_013.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_014.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_015.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_016.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_017.png" width="600" height="400" />
</div>
...
<div align = "center">
<Image src="/images/3dprint/3dpr_018.png" width="600" height="400" />
</div>
...
### Slicing with Cura
    ...
    <br></br>
    <div align = "center">
    <Image src="/images/3dprint/3dpr_019.png" width="600" height="400" />
    </div>

    <br></br>
    <br></br>

    - If this is the first time using the software, select the printer drop down menu and select `Add printer`.

    <br></br>
    <br></br>

    <div align = "center">
    <Image src="/images/3dprint/3dpr_021.png" width="600" height="400" />
    </div>

    <br></br>
    <br></br>

    - Then click `Add non-networked printer` and select `Ultimaker S5` and press `Add`.

    <br></br>
    <br></br>

    <div align = "center">
    <Image src="/images/3dprint/3dpr_022.png" width="600" height="400" />
    </div>
    ...
    - In the printer settings menu the `Profile` drop down menu select *Draft -Fast*.
    - Insert your usb drive into the computer.
    - Now click the blue `Slice` button.
...
You should now see something like this:
    ...
    <div align = "center">
    <Image src="/images/3dprint/3dpr_023.png" width="600" height="400" />
    </div>

    <br></br>
    <br></br>

    - Select the `Save to Removable Drive` option.
    - Then properly eject the usb drive from the computer.

    - Now plug the usb into the usb port at the front of the S5.
    - On the touchscreen select `Print from USB` and select the file you just saved.
    - Then press `Print`.
...
The best guide we have found for trouble shooting issues is [here](https://www.simplify3d.com/resources/print-quality-troubleshooting/). We suggest you start there, but here are few common issues and how to fix them.
